...
/* Include your existing STM32 header */
#include "stm32f4xx.h"
...
/* Position definitions if missing */
...
/* CoreDebug compatibility */
#ifndef CoreDebug_DHCSR_C_DEBUGEN_Msk
#define CoreDebug_DHCSR_C_DEBUGEN_Msk (1UL << 0)
#endif

/* SCB definitions if missing */
...
#warning "Loading STM32 compatibility header"  /* This should show up during compilation */

/* Include your existing STM32 header */
#include "stm32f4xx.h"

/* Force define TIM2 if not present */
#ifndef TIM2
#warning "TIM2 not defined, creating compatibility definition"
#define TIM2_BASE              (0x40000000UL)
#define TIM2                   ((TIM_TypeDef *) TIM2_BASE)
#endif
