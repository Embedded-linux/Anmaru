...
extern volatile uint32_t* const TIM2_CR1;
extern volatile uint32_t* const TIM2_DIER;
extern volatile uint32_t* const TIM2_SR;
extern volatile uint32_t* const TIM2_CNT;
