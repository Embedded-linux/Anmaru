...
dsrtos_error_t dsrtos_memory_get_stats(uint32_t* total, uint32_t* allocated, uint32_t* peak);
...
static system_health_status_t perform_health_monitoring(void)
{
    ...
    uint32_t memory_total, memory_allocated, memory_peak;
    dsrtos_result_t result;
...
/*
dsrtos_result_t dsrtos_boot_init(void) { return DSRTOS_SUCCESS; }
dsrtos_result_t dsrtos_clock_init(void) { return DSRTOS_SUCCESS; }
/* CERTIFIED_DUPLICATE_REMOVED: dsrtos_result_t dsrtos_debug_init(void) { return DSRTOS_SUCCESS; }
*/
