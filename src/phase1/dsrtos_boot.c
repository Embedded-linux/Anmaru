...
/* Function declarations are now available from core_cm4.h via stm32f4xx.h */
...
#define DSRTOS_BOOT_STAGE_INIT           (0xFFU)
#define DSRTOS_BOOT_STAGE_COMPLETE       (0xFEU)
...
/* Validation functions removed - not used in current implementation */
