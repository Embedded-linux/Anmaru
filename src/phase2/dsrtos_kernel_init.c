...
/* External symbols for memory layout */
...
static dsrtos_error_t kernel_execute_init_phase(dsrtos_init_phase_t phase)
{
    ...
    switch (phase) {
        ...
        case DSRTOS_INIT_PHASE_MAX:
            /* Invalid phase - should not be called */
            result = DSRTOS_ERROR_INVALID_PARAM;
            break;
...
static void kernel_set_state(dsrtos_kernel_state_t new_state)
{
    ...
    switch (new_state) {
        ...
        case DSRTOS_KERNEL_STATE_UNINITIALIZED:
            /* Cannot transition to uninitialized state */
            valid_transition = false;
            break;
            
        case DSRTOS_KERNEL_STATE_MAX:
            /* Invalid state */
            valid_transition = false;
            break;
