...
#ifndef DSRTOS_ERROR_NOT_ENABLED
#define DSRTOS_ERROR_NOT_ENABLED    (0x1000U)
#endif

#ifndef DSRTOS_TASK_STATE_RUNNING
#define DSRTOS_TASK_STATE_RUNNING   (0x01U)
#endif

#ifndef DSRTOS_TASK_STATE_READY
#define DSRTOS_TASK_STATE_READY     (0x02U)
#endif

#ifndef DSRTOS_TASK_STATE_BLOCKED
#define DSRTOS_TASK_STATE_BLOCKED   (0x03U)
#endif

#ifndef DSRTOS_TASK_STATE_SUSPENDED
#define DSRTOS_TASK_STATE_SUSPENDED (0x04U)
#endif
                                            ...
                                            dsrtos_task_stats_t *stats)
{
    ...
    dsrtos_critical_enter();
    stats->total_runtime = tcb->stats.total_runtime;
    stats->max_runtime = tcb->stats.max_runtime;
    stats->min_runtime = tcb->stats.min_runtime;
    stats->context_switches = tcb->stats.context_switches;
    stats->preemptions = tcb->stats.preemptions;
    stats->deadline_misses = tcb->stats.deadline_misses;
    dsrtos_critical_exit();
...
dsrtos_error_t dsrtos_stats_reset_phase3(dsrtos_tcb_t *tcb)
{
    ...
    if (tcb == NULL) {
        ...
        tcb->stats.total_runtime = 0U;
        tcb->stats.max_runtime = 0U;
        tcb->stats.min_runtime = 0U;
        tcb->stats.context_switches = 0U;
        tcb->stats.preemptions = 0U;
        tcb->stats.deadline_misses = 0U;
