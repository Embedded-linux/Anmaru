...
#define SDIO_BASE           (APB2PERIPH_BASE + 0x12C00UL)
...
/* System Core Clock - already declared above */
...
/* USART peripheral definitions - Complete set */
#ifndef USART1_BASE
#define USART1_BASE         (APB2PERIPH_BASE + 0x1000UL)
#define USART3_BASE         (APB1PERIPH_BASE + 0x4800UL)
...
/* RCC enable bits for USART/UART */
#define RCC_APB2ENR_USART1EN    ((uint32_t)0x00000010)
#define RCC_APB2ENR_USART6EN    ((uint32_t)0x00000020)
#define RCC_APB1ENR_USART3EN    ((uint32_t)0x00040000)
#define RCC_APB1ENR_UART4EN     ((uint32_t)0x00080000)
...
#define USART_CR1_TCIE      ((uint32_t)0x00000040)  /* TC Interrupt Enable */
...
#define USART_CR2_STOP_1    ((uint32_t)0x00000000)  /* 1 Stop bit */
#define USART_CR2_STOP_0_5  ((uint32_t)0x00001000)  /* 0.5 Stop bit */
#define USART_CR2_STOP_2    ((uint32_t)0x00002000)  /* 2 Stop bits */
#define USART_CR2_STOP_1_5  ((uint32_t)0x00003000)  /* 1.5 Stop bits */
#define USART_CR2_CLKEN     ((uint32_t)0x00000800)  /* Clock Enable */
#define USART_CR2_CPOL      ((uint32_t)0x00000400)  /* Clock Polarity */
#define USART_CR2_CPHA      ((uint32_t)0x00000200)  /* Clock Phase */
#define USART_CR2_LBCL      ((uint32_t)0x00000100)  /* Last Bit Clock pulse */
#define USART_CR2_LBDIE     ((uint32_t)0x00000040)  /* LIN Break Detection IE */
#define USART_CR2_LBDL      ((uint32_t)0x00000020)  /* LIN Break Detection Length */
#define USART_CR2_ADD       ((uint32_t)0x0000000F)  /* Address of the USART node */

/* USART_CR3 bits */
#define USART_CR3_ONEBIT    ((uint32_t)0x00000800)  /* One sample bit method */
...
#define USART_SR_NE         ((uint32_t)0x00000004)  /* Noise Error */
